    ...
    internal class ProductSeed : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product { Id = 3, Name = "Kalem 3", CategoryId = 1, Price = 500, Stock = 60, CreatedDate = DateTime.Now },
                new Product { Id = 4, Name = "Kitap 1", CategoryId = 2, Price = 100, Stock = 20, CreatedDate = DateTime.Now },
                new Product { Id = 5, Name = "Kitap 1", CategoryId = 2, Price = 100, Stock = 20, CreatedDate = DateTime.Now });
        }
    }
}
